...
- **pmca-web**: A web-based graphical user interface
...
./pmca-web.py  # for the gui application
```
...
- **pmca-web**: In the *Install App* tab, select an app from the list and click *Install*.
...
- **pmca-web**: In the *Tweaks* tab, click *Start tweaking*. You can then use the checkboxes to configure your camera's settings.
